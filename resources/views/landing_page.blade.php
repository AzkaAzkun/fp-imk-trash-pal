...
<body class="bg-gradient-to-b from-[#ccffc3b2] via-[#FFFFFF] to-[#ccffc3b2]">
  <div>
    ...
    <section class="w-full px-4 mx-auto bg-opacity-0">
      <nav class="mx-auto px-4 flex flex-wrap p-6 justify-between items-center">
        ...
        <!-- Hamburger Button -->
        <button id="menu-toggle" class="lg:hidden p-2 border border-[#26C3F4] rounded">
        ...
        <!-- Menu Items -->
        <div id="menu" class="w-full lg:flex hidden mt-4 lg:mt-0 lg:w-auto lg:items-center">
          <div class="flex flex-col lg:flex-row w-full items-center">
            <div class="text-lg font-semibold flex gap-7 mr-0 lg:mr-24 mb-4 lg:mb-0">
        ...
        : asset('images/foto-default.png') }}" alt="Foto Profil"
    ...
    <section id="hero" class="w-full bg-opacity-0">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between px-6 lg:px-24 py-16">
        <!-- Text Section -->
        <div class="w-full lg:w-1/2 mb-8 lg:mb-0 text-center lg:text-left">
          ...
          <p class="text-gray-600 text-[20px] lg:text-[30px] leading-relaxed mt-4">
        ...
        <div class="hidden lg:flex w-full lg:w-1/2 justify-center">
          <img src="{{  asset('images/img_hero.png')}}" class="max-w-full h-auto" alt="Hero Image" />
        </div>
      </div>
    </section>
  </div>
  ...
  <section
    ...
    <div class="hidden lg:flex justify-center">
      <img src="{{ asset('images/img4.png') }}" alt="Pendaftaran Bank Sampah" class="max-w-full h-auto rounded-md" />
    </div>
  </section>
